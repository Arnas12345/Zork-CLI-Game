...
Demon::Demon(string name, int health, double stamina) : //****************** 9. Initializer list
    Enemy(name, health, stamina) {} //****************** 2. Inheritance and cascading constructors

void Demon::typeOfAttack(){ //****************** 8. Abstract classes and pure virtual functions
    cout << "The demon hits you with his hooves " << endl;
}

void Demon::Attack(Character * a, Enemy * b){  //****************** 7. Virtual functions and polymorphism
...
void Demon::printName() //****************** 10. Dynamic and static dispatch
{
    cout << getName();
}
